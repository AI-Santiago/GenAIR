...
# categories and brand are treated as attributes
...
def main(data_name, data_type='Amazon', user_core=5, item_core=5):
...
if __name__ == "__main__":
    ...
    main('yelp', data_type='Yelp', user_core=5, item_core=5)
